...
// A non contiguous collection in memory where each element has a pointer to neighbouring elements in the heap.
...
// TODO: Clone function
// TODO: Unwrap functions for popping
// TODO: Free function
...
// Take the last element off of the list
bool LIST_SYMBOL(pop_back)(LIST_TYPE* list, LIST_TEMPLATE* out);
// Take the first element off of the list
bool LIST_SYMBOL(pop_front)(LIST_TYPE* list, LIST_TEMPLATE* out);
// Remove the element from the list and returns the next iter 
...
// Returns an iterator with the element
iter_t LIST_SYMBOL(iter)(const LIST_TYPE* list, const LIST_TEMPLATE* element);
// Returns an iterator at the first element
